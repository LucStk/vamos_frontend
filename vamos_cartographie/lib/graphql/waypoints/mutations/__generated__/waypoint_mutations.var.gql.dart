...
class GAttachImageToWaypointVars {
  const GAttachImageToWaypointVars({
    required this.waypointId,
    required this.fileKey,
  });

  factory GAttachImageToWaypointVars.fromJson(Map<String, dynamic> json) {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GAttachImageToWaypointVars &&
            _gqlUtils.deepEquals(toJson(), other.toJson()));
  }
  ...
  @override
  String toString() {
    return 'GAttachImageToWaypointVars(waypointId: $waypointId, fileKey: $fileKey)';
  }
}
