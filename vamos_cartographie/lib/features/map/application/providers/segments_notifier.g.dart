...
@ProviderFor(_segmentRepository)
final _segmentRepositoryProvider = _SegmentRepositoryProvider._();

final class _SegmentRepositoryProvider
    extends
        $FunctionalProvider<
          ISegmentRepository,
          ISegmentRepository,
          ISegmentRepository
        >
    with $Provider<ISegmentRepository> {
  _SegmentRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'_segmentRepositoryProvider',
        isAutoDispose: true,
        dependencies: null,
  ...
  @override
  String debugGetCreateSourceHash() => _$_segmentRepositoryHash();

  @$internal
  @override
  $ProviderElement<ISegmentRepository> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  ISegmentRepository create(Ref ref) {
    return _segmentRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(ISegmentRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<ISegmentRepository>(value),
    );
  }
}

String _$_segmentRepositoryHash() =>
    r'61eae49170a28d43162896f5c5e458ddc33745c0';
