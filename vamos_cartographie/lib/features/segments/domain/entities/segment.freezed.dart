...
/// Create a copy of Segment
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? type = freezed,Object? intermediatePoints = null,}) {
...
class _Segment extends Segment {
  const _Segment({this.id, this.type = GSegmentTypeEnum.bike, final  List<LatLng> intermediatePoints = const []}): _intermediatePoints = intermediatePoints,super._();
...
/// Create a copy of Segment
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? type = freezed,Object? intermediatePoints = null,}) {
