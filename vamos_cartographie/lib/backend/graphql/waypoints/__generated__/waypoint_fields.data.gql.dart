...
class GWaypointFieldsData implements GWaypointFields {
  ...
  @override
  int get hashCode {
    return Object.hash(runtimeType, id, poiCategory, title, description, vertex,
        _gqlUtils.listHash(images), G__typename);
  }

  @override
  String toString() {
    return 'GWaypointFieldsData(id: $id, poiCategory: $poiCategory, title: $title, description: $description, vertex: $vertex, images: $images, G__typename: $G__typename)';
  }
}
