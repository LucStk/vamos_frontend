...
import 'package:vamos_cartographie/backend/graphql/media/__generated__/image_fields.ast.gql.dart'
    as _i7;
import 'package:vamos_cartographie/backend/graphql/media/__generated__/media_mutations.ast.gql.dart'
    as _i6;
import 'package:vamos_cartographie/backend/graphql/media/__generated__/media_mutations.data.gql.dart'
    as _i2;
...
class GDeleteImageFromReq
    implements
        _i1
        .OperationRequest<_i2.GDeleteImageFromData, _i3.GDeleteImageFromVars> {
  GDeleteImageFromReq({
    required this.vars,
    _i4.Operation? operation,
    this.requestId,
  ...
  final _i3.GDeleteImageFromVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GDeleteImageFromData? Function(
    _i2.GDeleteImageFromData?,
    _i2.GDeleteImageFromData?,
  )? updateResult;

  final _i2.GDeleteImageFromData? optimisticResponse;
  ...
  static const _i5.DocumentNode _document =
      _i5.DocumentNode(definitions: [_i6.DeleteImageFrom]);

  static const _i4.Operation _operation = _i4.Operation(
    document: _document,
    operationName: 'DeleteImageFrom',
  );
  ...
  _i2.GDeleteImageFromData? parseData(Map<String, dynamic> json) =>
      _i2.GDeleteImageFromData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(_i2.GDeleteImageFromData data) =>
      data.toJson();

  _i1.OperationRequest<_i2.GDeleteImageFromData, _i3.GDeleteImageFromVars>
      transformOperation(_i4.Operation Function(_i4.Operation) transform) {
    return GDeleteImageFromReq(
      vars: vars,
      operation: transform(operation),
      requestId: requestId,
      updateResult: updateResult,
  ...
  GDeleteImageFromReq copyWith({
    _i3.GDeleteImageFromVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GDeleteImageFromData? Function(
      _i2.GDeleteImageFromData?,
      _i2.GDeleteImageFromData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GDeleteImageFromData? optimisticResponse,
    bool optimisticResponseIsSet = false,
    String? updateCacheHandlerKey,
    bool updateCacheHandlerKeyIsSet = false,
    Map<String, dynamic>? updateCacheHandlerContext,
  ...
  @override
  String toString() {
    return 'GDeleteImageFromReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}

class GAttachImageToReq
    implements
        _i1.OperationRequest<_i2.GAttachImageToData, _i3.GAttachImageToVars> {
  GAttachImageToReq({
    required this.vars,
    _i4.Operation? operation,
    this.requestId,
  ...
  final _i3.GAttachImageToVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GAttachImageToData? Function(
    _i2.GAttachImageToData?,
    _i2.GAttachImageToData?,
  )? updateResult;

  final _i2.GAttachImageToData? optimisticResponse;
  ...
  _i2.GAttachImageToData? parseData(Map<String, dynamic> json) =>
      _i2.GAttachImageToData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(_i2.GAttachImageToData data) => data.toJson();

  _i1.OperationRequest<_i2.GAttachImageToData, _i3.GAttachImageToVars>
      transformOperation(_i4.Operation Function(_i4.Operation) transform) {
    return GAttachImageToReq(
      vars: vars,
      operation: transform(operation),
      requestId: requestId,
      updateResult: updateResult,
  ...
  GAttachImageToReq copyWith({
    _i3.GAttachImageToVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GAttachImageToData? Function(
      _i2.GAttachImageToData?,
      _i2.GAttachImageToData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GAttachImageToData? optimisticResponse,
    bool optimisticResponseIsSet = false,
    String? updateCacheHandlerKey,
    bool updateCacheHandlerKeyIsSet = false,
    Map<String, dynamic>? updateCacheHandlerContext,
  ...
  @override
  String toString() {
    return 'GAttachImageToReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
