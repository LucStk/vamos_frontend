...
class GAttachFileToTripReq
    implements
        _i1.OperationRequest<_i2.GAttachFileToTripData,
            _i8.GAttachFileToTripVars> {
  ...
  final _i8.GAttachFileToTripVars vars;

  final _i3.Operation operation;

  final String? requestId;

  final _i2.GAttachFileToTripData? Function(
    _i2.GAttachFileToTripData?,
    _i2.GAttachFileToTripData?,
  )? updateResult;

  final _i2.GAttachFileToTripData? optimisticResponse;
  ...
  static const _i4.DocumentNode _document = _i4.DocumentNode(definitions: [
    _i5.AttachFileToTrip,
    _i6.StoredFile,
  ]);

  static const _i3.Operation _operation = _i3.Operation(
    document: _document,
    operationName: 'AttachFileToTrip',
  );
  ...
  _i2.GAttachFileToTripData? parseData(Map<String, dynamic> json) =>
      _i2.GAttachFileToTripData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(_i2.GAttachFileToTripData data) =>
      data.toJson();

  _i1.OperationRequest<_i2.GAttachFileToTripData, _i8.GAttachFileToTripVars>
      transformOperation(_i3.Operation Function(_i3.Operation) transform) {
    return GAttachFileToTripReq(
      vars: vars,
      operation: transform(operation),
      requestId: requestId,
      updateResult: updateResult,
  ...
  GAttachFileToTripReq copyWith({
    _i8.GAttachFileToTripVars? vars,
    _i3.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GAttachFileToTripData? Function(
      _i2.GAttachFileToTripData?,
      _i2.GAttachFileToTripData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GAttachFileToTripData? optimisticResponse,
    bool optimisticResponseIsSet = false,
    String? updateCacheHandlerKey,
    bool updateCacheHandlerKeyIsSet = false,
    Map<String, dynamic>? updateCacheHandlerContext,
  ...
  @override
  String toString() {
    return 'GAttachFileToTripReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
