...
class GAttachFileToTripData {
  const GAttachFileToTripData({
    required this.attachFileToTrip,
    this.G__typename = 'Mutation',
  });

  factory GAttachFileToTripData.fromJson(Map<String, dynamic> json) {
    return GAttachFileToTripData(
      attachFileToTrip: _i2.GStoredFileData.fromJson(
          (json['attachFileToTrip'] as Map<String, dynamic>)),
      G__typename: (json['__typename'] as String),
    );
  }

  final _i2.GStoredFileData attachFileToTrip;

  final String G__typename;

  Map<String, dynamic> toJson() {
    final _$result = <String, dynamic>{};
    _$result['attachFileToTrip'] = this.attachFileToTrip.toJson();
    _$result['__typename'] = this.G__typename;
    return _$result;
  }

  GAttachFileToTripData copyWith({
    _i2.GStoredFileData? attachFileToTrip,
    String? G__typename,
  }) {
    return GAttachFileToTripData(
      attachFileToTrip: attachFileToTrip ?? this.attachFileToTrip,
      G__typename: G__typename ?? this.G__typename,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GAttachFileToTripData &&
            attachFileToTrip == other.attachFileToTrip &&
            G__typename == other.G__typename);
  }

  @override
  int get hashCode {
    return Object.hash(runtimeType, attachFileToTrip, G__typename);
  }

  @override
  String toString() {
    return 'GAttachFileToTripData(attachFileToTrip: $attachFileToTrip, G__typename: $G__typename)';
  }
}
