...
import 'package:vamos_cartographie/domain_features/stored_file/data/graphql/__generated__/file_storage_fields.ast.gql.dart'
    as _i7;
import 'package:vamos_cartographie/domain_features/stored_file/data/graphql/__generated__/file_storage_mutations.ast.gql.dart'
    as _i6;
import 'package:vamos_cartographie/domain_features/stored_file/data/graphql/__generated__/file_storage_mutations.data.gql.dart'
    as _i2;
import 'package:vamos_cartographie/domain_features/stored_file/data/graphql/__generated__/file_storage_mutations.var.gql.dart'
    as _i3;
...
class GAttachFileReq
    implements _i1.OperationRequest<_i2.GAttachFileData, _i3.GAttachFileVars> {
  GAttachFileReq({
    required this.vars,
    _i4.Operation? operation,
    this.requestId,
  ...
  final _i3.GAttachFileVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GAttachFileData? Function(
    _i2.GAttachFileData?,
    _i2.GAttachFileData?,
  )? updateResult;

  final _i2.GAttachFileData? optimisticResponse;
  ...
  _i2.GAttachFileData? parseData(Map<String, dynamic> json) =>
      _i2.GAttachFileData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(_i2.GAttachFileData data) => data.toJson();

  _i1.OperationRequest<_i2.GAttachFileData, _i3.GAttachFileVars>
      transformOperation(_i4.Operation Function(_i4.Operation) transform) {
    return GAttachFileReq(
      vars: vars,
      operation: transform(operation),
      requestId: requestId,
      updateResult: updateResult,
  ...
  GAttachFileReq copyWith({
    _i3.GAttachFileVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GAttachFileData? Function(
      _i2.GAttachFileData?,
      _i2.GAttachFileData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GAttachFileData? optimisticResponse,
    bool optimisticResponseIsSet = false,
    String? updateCacheHandlerKey,
    bool updateCacheHandlerKeyIsSet = false,
    Map<String, dynamic>? updateCacheHandlerContext,
  ...
  @override
  String toString() {
    return 'GAttachFileReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
