...
import 'package:vamos_cartographie/domain_features/topology/data/graphql/fields/__generated__/vertex_fields.ast.gql.dart'
    as _i8;
import 'package:vamos_cartographie/domain_features/topology/data/graphql/queries/__generated__/segment_queries.ast.gql.dart'
    as _i6;
import 'package:vamos_cartographie/domain_features/topology/data/graphql/queries/__generated__/segment_queries.data.gql.dart'
    as _i2;
import 'package:vamos_cartographie/domain_features/topology/data/graphql/queries/__generated__/segment_queries.var.gql.dart'
    as _i3;

class GGetSegmentsReq
    implements
        _i1.OperationRequest<_i2.GGetSegmentsData, _i3.GGetSegmentsVars> {
  GGetSegmentsReq({
    required this.vars,
  ...
  final _i3.GGetSegmentsVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GGetSegmentsData? Function(
    _i2.GGetSegmentsData?,
    _i2.GGetSegmentsData?,
  )? updateResult;

  final _i2.GGetSegmentsData? optimisticResponse;
  ...
  _i2.GGetSegmentsData? parseData(Map<String, dynamic> json) =>
      _i2.GGetSegmentsData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(_i2.GGetSegmentsData data) => data.toJson();

  _i1.OperationRequest<_i2.GGetSegmentsData, _i3.GGetSegmentsVars>
      transformOperation(_i4.Operation Function(_i4.Operation) transform) {
    return GGetSegmentsReq(
      vars: vars,
  ...
  GGetSegmentsReq copyWith({
    _i3.GGetSegmentsVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GGetSegmentsData? Function(
      _i2.GGetSegmentsData?,
      _i2.GGetSegmentsData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GGetSegmentsData? optimisticResponse,
  ...
  @override
  String toString() {
    return 'GGetSegmentsReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
