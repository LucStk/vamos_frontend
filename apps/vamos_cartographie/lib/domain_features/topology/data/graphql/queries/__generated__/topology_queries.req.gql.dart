...
import 'package:vamos_cartographie/domain_features/topology/data/graphql/fields/__generated__/vertex_fields.ast.gql.dart'
    as _i8;
import 'package:vamos_cartographie/domain_features/topology/data/graphql/queries/__generated__/topology_queries.ast.gql.dart'
    as _i6;
import 'package:vamos_cartographie/domain_features/topology/data/graphql/queries/__generated__/topology_queries.data.gql.dart'
    as _i2;
import 'package:vamos_cartographie/domain_features/topology/data/graphql/queries/__generated__/topology_queries.var.gql.dart'
    as _i3;

class GGetTopologyReq
    implements
  ...
  final _i3.GGetTopologyVars vars;
  ...
  GGetTopologyReq copyWith({
    _i3.GGetTopologyVars? vars,
    _i4.Operation? operation,
    String? requestId,
  ...
  @override
  String toString() {
    return 'GGetTopologyReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
