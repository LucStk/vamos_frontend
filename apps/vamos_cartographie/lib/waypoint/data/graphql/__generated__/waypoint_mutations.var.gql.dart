...
class GAttachFileToWaypointVars {
  const GAttachFileToWaypointVars({required this.input});

  factory GAttachFileToWaypointVars.fromJson(Map<String, dynamic> json) {
    return GAttachFileToWaypointVars(
        input: _i1.GAttachFileWaypointInput.fromJson(
            (json['input'] as Map<String, dynamic>)));
  }

  final _i1.GAttachFileWaypointInput input;
  ...
  GAttachFileToWaypointVars copyWith({_i1.GAttachFileWaypointInput? input}) {
    return GAttachFileToWaypointVars(input: input ?? this.input);
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GAttachFileToWaypointVars &&
            _gqlUtils.deepEquals(toJson(), other.toJson()));
  }
  ...
  @override
  String toString() {
    return 'GAttachFileToWaypointVars(input: $input)';
  }
}
