...
import 'package:vamos_cartographie/waypoint/data/graphql/__generated__/waypoint_fields.ast.gql.dart'
    as _i8;
import 'package:vamos_cartographie/waypoint/data/graphql/__generated__/waypoint_mutations.ast.gql.dart'
    as _i6;
import 'package:vamos_cartographie/waypoint/data/graphql/__generated__/waypoint_mutations.data.gql.dart'
    as _i2;
import 'package:vamos_cartographie/waypoint/data/graphql/__generated__/waypoint_mutations.var.gql.dart'
    as _i3;
...
class GCreateBlankWaypointFromPositionReq
    implements
        _i1.OperationRequest<_i2.GCreateBlankWaypointFromPositionData,
            _i3.GCreateBlankWaypointFromPositionVars> {
  ...
  final _i3.GCreateBlankWaypointFromPositionVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GCreateBlankWaypointFromPositionData? Function(
    _i2.GCreateBlankWaypointFromPositionData?,
    _i2.GCreateBlankWaypointFromPositionData?,
  )? updateResult;

  final _i2.GCreateBlankWaypointFromPositionData? optimisticResponse;
  ...
  static const _i4.Operation _operation = _i4.Operation(
    document: _document,
    operationName: 'CreateBlankWaypointFromPosition',
  );
  ...
  _i2.GCreateBlankWaypointFromPositionData? parseData(
          Map<String, dynamic> json) =>
      _i2.GCreateBlankWaypointFromPositionData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(
          _i2.GCreateBlankWaypointFromPositionData data) =>
      data.toJson();

  _i1.OperationRequest<_i2.GCreateBlankWaypointFromPositionData,
          _i3.GCreateBlankWaypointFromPositionVars>
      transformOperation(_i4.Operation Function(_i4.Operation) transform) {
    return GCreateBlankWaypointFromPositionReq(
      vars: vars,
      operation: transform(operation),
      requestId: requestId,
      updateResult: updateResult,
  ...
  GCreateBlankWaypointFromPositionReq copyWith({
    _i3.GCreateBlankWaypointFromPositionVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GCreateBlankWaypointFromPositionData? Function(
      _i2.GCreateBlankWaypointFromPositionData?,
      _i2.GCreateBlankWaypointFromPositionData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GCreateBlankWaypointFromPositionData? optimisticResponse,
    bool optimisticResponseIsSet = false,
    String? updateCacheHandlerKey,
    bool updateCacheHandlerKeyIsSet = false,
    Map<String, dynamic>? updateCacheHandlerContext,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GCreateBlankWaypointFromPositionReq &&
            _gqlUtils.deepEquals(varsToJson(), other.varsToJson()) &&
            operation == other.operation &&
            requestId == other.requestId &&
            updateResult == other.updateResult &&
  ...
  @override
  String toString() {
    return 'GCreateBlankWaypointFromPositionReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}

class GCreateBlankWaypointFromVertexReq
    implements
        _i1.OperationRequest<_i2.GCreateBlankWaypointFromVertexData,
            _i3.GCreateBlankWaypointFromVertexVars> {
  ...
  final _i3.GCreateBlankWaypointFromVertexVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GCreateBlankWaypointFromVertexData? Function(
    _i2.GCreateBlankWaypointFromVertexData?,
    _i2.GCreateBlankWaypointFromVertexData?,
  )? updateResult;

  final _i2.GCreateBlankWaypointFromVertexData? optimisticResponse;
  ...
  static const _i4.Operation _operation = _i4.Operation(
    document: _document,
    operationName: 'CreateBlankWaypointFromVertex',
  );
  ...
  _i2.GCreateBlankWaypointFromVertexData? parseData(
          Map<String, dynamic> json) =>
      _i2.GCreateBlankWaypointFromVertexData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(
          _i2.GCreateBlankWaypointFromVertexData data) =>
      data.toJson();

  _i1.OperationRequest<_i2.GCreateBlankWaypointFromVertexData,
          _i3.GCreateBlankWaypointFromVertexVars>
      transformOperation(_i4.Operation Function(_i4.Operation) transform) {
    return GCreateBlankWaypointFromVertexReq(
      vars: vars,
      operation: transform(operation),
      requestId: requestId,
      updateResult: updateResult,
  ...
  GCreateBlankWaypointFromVertexReq copyWith({
    _i3.GCreateBlankWaypointFromVertexVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GCreateBlankWaypointFromVertexData? Function(
      _i2.GCreateBlankWaypointFromVertexData?,
      _i2.GCreateBlankWaypointFromVertexData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GCreateBlankWaypointFromVertexData? optimisticResponse,
    bool optimisticResponseIsSet = false,
    String? updateCacheHandlerKey,
    bool updateCacheHandlerKeyIsSet = false,
    Map<String, dynamic>? updateCacheHandlerContext,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GCreateBlankWaypointFromVertexReq &&
            _gqlUtils.deepEquals(varsToJson(), other.varsToJson()) &&
            operation == other.operation &&
            requestId == other.requestId &&
            updateResult == other.updateResult &&
...
class GAttachFileToWaypointReq
    implements
        _i1.OperationRequest<_i2.GAttachFileToWaypointData,
            _i3.GAttachFileToWaypointVars> {
  ...
  final _i3.GAttachFileToWaypointVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GAttachFileToWaypointData? Function(
    _i2.GAttachFileToWaypointData?,
    _i2.GAttachFileToWaypointData?,
  )? updateResult;

  final _i2.GAttachFileToWaypointData? optimisticResponse;
  ...
  static const _i5.DocumentNode _document = _i5.DocumentNode(definitions: [
    _i6.AttachFileToWaypoint,
    _i7.StoredFile,
  ]);

  static const _i4.Operation _operation = _i4.Operation(
    document: _document,
    operationName: 'AttachFileToWaypoint',
  );
  ...
  _i2.GAttachFileToWaypointData? parseData(Map<String, dynamic> json) =>
      _i2.GAttachFileToWaypointData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(_i2.GAttachFileToWaypointData data) =>
      data.toJson();

  _i1.OperationRequest<_i2.GAttachFileToWaypointData,
          _i3.GAttachFileToWaypointVars>
      transformOperation(_i4.Operation Function(_i4.Operation) transform) {
    return GAttachFileToWaypointReq(
      vars: vars,
      operation: transform(operation),
      requestId: requestId,
      updateResult: updateResult,
  ...
  GAttachFileToWaypointReq copyWith({
    _i3.GAttachFileToWaypointVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GAttachFileToWaypointData? Function(
      _i2.GAttachFileToWaypointData?,
      _i2.GAttachFileToWaypointData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GAttachFileToWaypointData? optimisticResponse,
    bool optimisticResponseIsSet = false,
    String? updateCacheHandlerKey,
    bool updateCacheHandlerKeyIsSet = false,
    Map<String, dynamic>? updateCacheHandlerContext,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GAttachFileToWaypointReq &&
            _gqlUtils.deepEquals(varsToJson(), other.varsToJson()) &&
            operation == other.operation &&
            requestId == other.requestId &&
            updateResult == other.updateResult &&
  ...
  @override
  String toString() {
    return 'GAttachFileToWaypointReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
