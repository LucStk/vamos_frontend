...
class GConfirmImageUploadReq
    implements
        _i1.OperationRequest<_i2.GConfirmImageUploadData,
            _i3.GConfirmImageUploadVars> {
  GConfirmImageUploadReq({
    required this.vars,
    _i4.Operation? operation,
    this.requestId,
    this.updateResult,
  ...
  final _i3.GConfirmImageUploadVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GConfirmImageUploadData? Function(
    _i2.GConfirmImageUploadData?,
    _i2.GConfirmImageUploadData?,
  )? updateResult;

  final _i2.GConfirmImageUploadData? optimisticResponse;
  ...
  static const _i5.DocumentNode _document =
      _i5.DocumentNode(definitions: [_i6.ConfirmImageUpload]);

  static const _i4.Operation _operation = _i4.Operation(
    document: _document,
    operationName: 'ConfirmImageUpload',
  );
  ...
  _i2.GConfirmImageUploadData? parseData(Map<String, dynamic> json) =>
      _i2.GConfirmImageUploadData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(_i2.GConfirmImageUploadData data) =>
      data.toJson();

  _i1.OperationRequest<_i2.GConfirmImageUploadData, _i3.GConfirmImageUploadVars>
      transformOperation(_i4.Operation Function(_i4.Operation) transform) {
    return GConfirmImageUploadReq(
      vars: vars,
      operation: transform(operation),
      requestId: requestId,
      updateResult: updateResult,
  ...
  GConfirmImageUploadReq copyWith({
    _i3.GConfirmImageUploadVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GConfirmImageUploadData? Function(
      _i2.GConfirmImageUploadData?,
      _i2.GConfirmImageUploadData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GConfirmImageUploadData? optimisticResponse,
    bool optimisticResponseIsSet = false,
    String? updateCacheHandlerKey,
    bool updateCacheHandlerKeyIsSet = false,
    Map<String, dynamic>? updateCacheHandlerContext,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GConfirmImageUploadReq &&
            _gqlUtils.deepEquals(varsToJson(), other.varsToJson()) &&
            operation == other.operation &&
            requestId == other.requestId &&
            updateResult == other.updateResult &&
  ...
  @override
  String toString() {
    return 'GConfirmImageUploadReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
